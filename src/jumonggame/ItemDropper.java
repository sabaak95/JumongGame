 ...
 * @author felan
 */
public class ItemDropper extends JPanel {
    ...
    public ItemDropper( final Map map1, final Hero hero1) {
//        super("pick.....");
        this.map = map1;
        this.hero = hero1;
        JButton ok ;
        ...
        ok.addActionListener(new AbstractAction() {
            ...
            public void actionPerformed(ActionEvent e) {
                String itemNameToDrop = getSelectedButtonText(b);
                Tile current_tile = map.tiles[hero1.getX()][hero1.getY()];
                hero1.Drop(current_tile,itemNameToDrop);
                b.clearSelection();
